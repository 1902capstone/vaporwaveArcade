...
export default class LeaderBoardComponent2 extends Component {  
    static propTypes = {
    ...
    fontWeight: 'bold', fontSize: 25, color: "white" }}>Heartbreaker Leaderboard</Text>
          ...
          >
            <Image
              ...
              source={{
                uri:
                  "https://media0.giphy.com/media/xUOwG9fkX7kINUrIw8/giphy.gif?cid=790b76115cd9e4cc3149357332924f02&rid=giphy.gif"
              }}
            />
          </View>
        </View>
  ...
  module.exports = LeaderBoardComponent2
